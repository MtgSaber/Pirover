 ...
 * The first digit represents the motor states, and is treated as two 4-bit vectors,
 * with each position representing the truth of "is this the state?" The positions
 * map to states in the following manner, starting with MSB:
 * 
 * [Clockwise, Counterclockwise, Coast, Brake]
 * 
 * It should be noted that the resulting vector should be a power of 2, as only one position
 * is allowed to be HIGH at a time.
